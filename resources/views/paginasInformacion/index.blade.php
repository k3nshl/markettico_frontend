                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h5 class="text-dark"><i class="bx bx-notepad me-2 font-22  text-info"></i>Agregar
                                        Página
                                    </h5>
                                </div>
                                <hr>
                                <form action="{{ route('paginasInformacion.store') }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control img_selected" id="icono" name="icono">
                                        <div class="text-center p-3">
                                            <img src="#"
                                                alt="Vista previa de la imagen"
                                                class="rounded-3 preview_img_selected"
                                                    ...
                                                    <td>
                                                        <div class="text-center">
                                                            ...
                                                            <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                                                data-bs-target="#editarColeccionModal{{ $item->id_pagina_informacion }}"
                                                        ...
                                                        <div class="modal fade"
                                                            id="editarColeccionModal{{ $item->id_pagina_informacion }}"
                                                            tabindex="-1" aria-labelledby="editarColeccionModalLabel"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-scrollable">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="editarColeccionModalLabel">
                                                                            Editar Colección</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form
                                                                            ...
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input type="file" class="form-control img_selected"
                                                                                    id="icono" name="icono">
                                                                                <div class="text-center p-3">
                                                                                    <img src="/img/fotografias/{{ $item->icono }}"
                                                                                        alt="Vista previa de la imagen"
                                                                                        class="rounded-3 preview_img_selected"
                                                        ...
                                                        {{-- Modal eliminar --}}
                                                        <div class="modal fade"
                                                            id="eliminarPaginaModal{{ $item->id_pagina_informacion }}"
                                                            tabindex="-1" aria-labelledby="eliminarPaginaModalLabel"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="eliminarPaginaModalLabel">
                                                                            Confirmar
                                                                            eliminación</h5>
                                                                        <button type="button" class="btn-close"
