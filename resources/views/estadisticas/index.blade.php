							   ...
							   <table class="table table-hover align-items-center">
								 ...
								 <tbody>
									 <tr>
										 ...
										 <td>$4,586</td>
										 <td><span id="trendchart1"><canvas width="82" height="20" style="display: inline-block; width: 82px; height: 20px; vertical-align: top;"></canvas></span></td>
									 </tr>
									 <tr>
										 <td><i class="flag-icon flag-icon-us me-2"></i>Canada</td>
										 <td>$2,089</td>
										 <td><span id="trendchart2"><canvas width="82" height="20" style="display: inline-block; width: 82px; height: 20px; vertical-align: top;"></canvas></span></td>
									 </tr>
				   
									 <tr>
										 <td><i class="flag-icon flag-icon-in me-2"></i>India</td>
										 <td>$3,039</td>
										 <td><span id="trendchart3"><canvas width="82" height="20" style="display: inline-block; width: 82px; height: 20px; vertical-align: top;"></canvas></span></td>
									 </tr>
				   
									 <tr>
										 <td><i class="flag-icon flag-icon-gb me-2"></i>UK</td>
										 <td>$2,309</td>
										 <td><span id="trendchart4"><canvas width="82" height="20" style="display: inline-block; width: 82px; height: 20px; vertical-align: top;"></canvas></span></td>
									 </tr>
				   
									 <tr>
										 <td><i class="flag-icon flag-icon-de me-2"></i>Germany</td>
										 <td>$7,209</td>
										 <td><span id="trendchart5"><canvas width="82" height="20" style="display: inline-block; width: 82px; height: 20px; vertical-align: top;"></canvas></span></td>
									 </tr>
							 ...
							 <div class="col-12 col-lg-6">
							   <div class="card radius-10">
								<div class="card-body text-center">
								   ...
								   <div style="display:inline;width:190px;height:190px;"><canvas width="190" height="190"></canvas><input class="knob" data-width="190" data-height="190" data-readonly="true" data-thickness=".2" data-angleoffset="90" data-linecap="round" data-bgcolor="rgba(0, 0, 0, 0.08)" data-fgcolor="#843cf7" data-max="15000" value="8550" readonly="readonly" style="width: 99px; height: 63px; position: absolute; vertical-align: middle; margin-top: 63px; margin-left: -144px; border: 0px; background: none; font: bold 27px Arial; text-align: center; color: rgb(132, 60, 247); padding: 0px; appearance: none;"></div>
								   <hr>
